...
export function ArticleTitle({ children }) {
	return (
		<h1 className="mt-12 mb-3 text-4xl font-bold lg:leading-tight lg:text-5xl text-center">
			{children}
		</h1>
	)
}
...
export function ArticleMedia({ children }) {
	return (
		<div className="relative py-10 article--media -right-10 lg:right-0 lg:py-0">
